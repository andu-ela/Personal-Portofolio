...
const AboutMe = () => {
  return (
    <section className="relative min-h-screen flex justify-center items-center p-8 bg-gray-900 text-white">
      <div className="about-container flex flex-col md:flex-row justify-between items-center w-full max-w-6xl px-8">
             <div className="about-image relative w-96 h-96 mb-8 md:mb-0">
